...
class LibraryConfigs
{
	...
	{
		return val4(Git, parseProperty(v, "name", parseString, identity), parseProperty(v, "url", parseString, identity),
			parseOptionalStringProperty(v, "ref"), parseOptionalStringProperty(v, "dir"), Nel.semigroup());
	}
